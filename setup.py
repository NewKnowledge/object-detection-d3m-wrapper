...
setup(
    ...
    install_requires  = ['numpy>=1.14.0',
                         'object_detection_retinanet @ git+https://github.com/NewKnowledge/object-detection-retinanet@4fa4cedb78500777aec827e389c199c991822904#egg=object_detection_retinanet'],                        
    entry_points      = {
        'd3m.primitives': [
