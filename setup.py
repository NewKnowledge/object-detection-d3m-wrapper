...
setup(
    ...
    install_requires  = ['numpy>=1.15.4,<=1.17.3',
                         'object_detection_retinanet @ git+https://github.com/NewKnowledge/object-detection-retinanet@ff22f655d63dc39f40ec931b7516904e117a7abd#egg=object_detection_retinanet'],                        
    entry_points      = {
        'd3m.primitives': [
