...
setup(
    ...
    install_requires  = ['numpy>=1.14.0',
                         'object_detection_retinanet @ git+https://github.com/NewKnowledge/object-detection-retinanet@17638e417a13649e3c3c55e0ad4702118abd5989#egg=object_detection_retinanet'],                        
    entry_points      = {
        'd3m.primitives': [
