...
setup(
    ...
    install_requires  = ['numpy>=1.14.0',
                         'object_detection_retinanet @ git+https://github.com/NewKnowledge/object-detection-retinanet@9b122dba4ae945d9fd2fd08d5df9942cafdf32e7#egg=object_detection_retinanet'],                        
    entry_points      = {
        'd3m.primitives': [
