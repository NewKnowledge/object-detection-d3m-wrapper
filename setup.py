...
setup(
    ...
    install_requires  = ['numpy>=1.15.4,<=1.17.3',
                         'object_detection_retinanet @ git+https://github.com/NewKnowledge/object-detection-retinanet@225242a2210db878001802601315ad900c7a4229#egg=object_detection_retinanet'],                        
    entry_points      = {
        'd3m.primitives': [
