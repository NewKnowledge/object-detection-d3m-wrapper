...
setup(
    ...
    install_requires  = ['numpy>=1.15.4,<=1.17.3',
                         'object_detection_retinanet @ git+https://github.com/NewKnowledge/object-detection-retinanet@9fc2654b66481dd2f26f88c820cd3046f74db9c2#egg=object_detection_retinanet'],                        
    entry_points      = {
        'd3m.primitives': [
