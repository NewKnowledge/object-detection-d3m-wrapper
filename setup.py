...
setup(
    ...
    install_requires  = ['numpy>=1.15.4,<=1.17.3',
                         'object_detection_retinanet @ git+https://github.com/NewKnowledge/object-detection-retinanet@13f779fce21418cbe7dc9fc9fc4f25c601181f6e#egg=object_detection_retinanet'],                        
    entry_points      = {
        'd3m.primitives': [
