...
setup(
    ...
    install_requires  = ['numpy>=1.15.4,<=1.17.3',
                         'object_detection_retinanet @ git+https://github.com/NewKnowledge/object-detection-retinanet@54ce539d391b2f74db63a68a8b3b4c17a58fdcfe#egg=object_detection_retinanet'],                        
    entry_points      = {
        'd3m.primitives': [
