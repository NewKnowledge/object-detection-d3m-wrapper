...
setup(
    ...
    install_requires  = ['numpy>=1.14.0',
                         'object_detection_retinanet @ git+https://github.com/NewKnowledge/object-detection-retinanet@889105776249cf587625327a971a560efd457f99#egg=object_detection_retinanet'],                        
    entry_points      = {
        'd3m.primitives': [
